...
public class instruction extends JFrame implements ActionListener{
	...
	JLabel instruc4 = new JLabel("4. If you make mistake it will be added to the left counter");
	JLabel instruc5 = new JLabel("5. Remarks will be given below for right and wrong answer");
	Container c;
	...
	public instruction() {
		...
		instruc2.setBounds(103, 90, 508, 100);
		c.add(instruc2);
		
		instruc3.setFont(new Font("Tahoma", Font.BOLD, 30));
		instruc3.setBounds(103, 166, 992, 100);
		c.add(instruc3);
		
		instruc4.setFont(new Font("Tahoma", Font.BOLD, 30));
		instruc4.setBounds(103, 321, 1020, 100);
		c.add(instruc4);
		
		instruc5.setFont(new Font("Tahoma", Font.BOLD, 30));
		instruc5.setBounds(103, 402, 923, 100);
		c.add(instruc5);
		...
		lblThereWill.setBounds(103, 242, 1020, 100);
