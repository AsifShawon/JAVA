...
public class Registration implements ActionListener {
    ...
    public Registration() {
        ...
        nameF.setFont(new Font("Dialog", Font.PLAIN, 15));
        ...
        idF = new JTextField();
        idF.setFont(new Font("Dialog", Font.PLAIN, 15));
        idF.setSize(127, 30);
        ...
        phnF = new JTextField();
        phnF.setFont(new Font("Dialog", Font.PLAIN, 15));
        phnF.setSize(127, 30);
        ...
        deptF.setFont(new Font("Dialog", Font.PLAIN, 15));
        ...
        emailF.setFont(new Font("Dialog", Font.PLAIN, 15));
        emailF.setSize(165, 30);
        ...
        dobF = new JTextField();
        dobF.setFont(new Font("Dialog", Font.PLAIN, 15));
        dobF.setSize(127, 30);
        ...
        addressF.setFont(new Font("Dialog", Font.PLAIN, 15));
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == submit) {
            ...
            if (name.equals("") || id.equals("") || phnum.equals("") || dept.equals("") || email.equals("") || dob.equals("") || address.equals("")) {
                JOptionPane.showMessageDialog(null, "Fill all the details", "Error", JOptionPane.ERROR_MESSAGE);
            } else {
                File f = new File("voter.ser");
                try (ObjectOutputStream oos = f.exists() ? 
                        new AppendingObjectOutputStream(new FileOutputStream(f, true)) : 
